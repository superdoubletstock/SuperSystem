        ...
        <div class="col-lg-12">
            <div class="content-panel">
                ...
                $main_store_query = "SELECT 
                    ...
                    INNER JOIN inventory_items ON main_store_history.item_code = inventory_items.item_code";
                ...
                if ($role == "admin" && $sub_role == "admin") {
                ?>
                    <button class="btn btn-success" style="float: left; margin-right: 10px; " data-toggle="modal" data-target="#saveReportModal" <?= $disabled ?>>Save</button>
                <?php
                }
                ?>
...
<!-- Save Report Modal -->
<div class="modal fade" id="saveReportModal" tabindex="-1" role="dialog" aria-labelledby="addModalLabel" aria-hidden="true">
