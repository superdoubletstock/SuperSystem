            ...
            <section class="wrapper">
                <div class="row">
                        ...
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form method="POST" action="../assets/php_query/super_admin_query/settingsQuery.php">
                    ...
                    <div class="modal fade" id="diactivateUser" tabindex="-1" role="dialog"
                        ...
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                <form id="deleteForm" action="../assets/php_query/super_admin_query/settingsQuery.php" method="post">
                                    <div class="modal-header">
