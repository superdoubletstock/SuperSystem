...
<body>
            ...
            <section class="wrapper">
                <div class="row">
                    <div class="col-lg-12 main-chart">
                        <h1>Inverntory Items Control </h1>
                        <div class="row mt">
                            <div class="col-lg-12">
                                <div class="content-panel">
                                    ...
                                    <section id="unseen">
                                        <table class="table table-bordered table-striped table-condensed" id="InventoryItemTable" style="table-layout: auto;">
                                            <thead>
                                                <tr>
                                                    <th>ITEM CODE</th>
                                                    <th>DISCRIPTION</th>
                                            ...
                                            <tbody>
                                                ...
                                                ?>
                                                        <tr>
                                                            <td><?php echo $inventory_row['item_code']; ?></td>
                                                            <td><?php echo $inventory_row['item_description']; ?></td>
                                                            <td class="numeric"><?php echo $inventory_row['conversion_rate']; ?></td>
                                                            <td class="numeric"><?php echo $inventory_row['category']; ?></td>
                                                            <td class="numeric"><?php echo $inventory_row['uom']; ?></td>
                                                            <td class="numeric"><?php echo $inventory_row['origin']; ?></td>
                                                            <td class="numeric"><?php echo $inventory_row['unit_cost']; ?></td>

                                                            <td class="numeric"><?php echo $inventory_row['unit_price']; ?></td>
                                                            <td class="numeric"><?php echo $inventory_row['status_of_Item']; ?></td>
                                                            <td class="numeric"><?php echo $inventory_row['inserted_at']; ?></td>


                                                            <td><button class="btn btn-primary editItemBtn" data-toggle="modal"
                                                                    data-target="#editItemData"
                                                                    data-id="<?php echo $inventory_row['item_code']; ?>"><i class="fas fa-pen"></i></button></td>
                                                            ...
                                                            <td><button class="btn btn-danger diactivateItemBtn" data-toggle="modal"
                                                                    ...
                                                                    data-id="<?php echo $inventory_row['item_code']; ?>"><i class="fas fa-trash"></i></button></td>
                                                        </tr>
                                                <?php
                        ...
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form method="POST" action="../assets/php_query/super_admin_query/RawMaterialQuery.php">
                    ...
                    <div class="modal fade" id="diactivateItem" tabindex="-1" role="dialog"
                        ...
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                <form id="deleteForm" action="../assets/php_query/super_admin_query/RawMaterialQuery.php" method="post">
                                    <div class="modal-header">
    ...
    <script>
        ...
        let hist_allRows = Array.from(document.querySelectorAll('#InventoryItemTable tbody tr'));
        let hist_filteredRows = [...hist_allRows];

        const hist_table = document.getElementById('InventoryItemTable');
        ...
        hist_printBtn.addEventListener('click', () => {
            ...
            const visibleRows = document.querySelectorAll('#InventoryItemTable tbody tr');
    ...
    <script>
        ...
        $(document).ready(function() {
            $('#InventoryItemTable').on('click', '.editItemBtn', function() {
    ...
    <script>
        ...
        $(document).ready(function() {
            $('#InventoryItemTable').on('click', '.diactivateItemBtn', function() {
                var $row = $(this).closest('tr'); // Get the closest table row
                var firstCellData = $row.find('td:eq(0)').text().trim(); // First cell
...
// Display loading GIF
    resultDiv.innerHTML = '<img src="https://i.gifer.com/ZZ5H.gif" alt="Loading..." style="width: 24px;">';
            ...
            fetch('../assets/php_query/super_admin_query/RawMaterialQuery.php', {
                    method: 'POST',
                    body: formData
                })
                .then(res => res.text())
