            ...
            if ($db_In_Out_status == "OUT") {
                ...
                if ($balanceResult->num_rows > 0) {
                    ...
                    if ($db_department == "paint_mini_store") {
                        ...
                        $main_store_balance_query = "SELECT team1_accepet, team2_accept FROM paint_mini_store_request WHERE transaction_id = '$acceptItemCode'";
                    $main_store_balance_query_run = mysqli_query($conn, $main_store_balance_query);

          if ($main_store_balance_query_run && mysqli_num_rows($main_store_balance_query_run) > 0) {
    $balance_row = mysqli_fetch_assoc($main_store_balance_query_run);
