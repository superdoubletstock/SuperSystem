            ...
            <section class="wrapper">
                <div class="row">
                    <div class="col-lg-12 main-chart">
                        ...
                        <h1>fiber Mini Store History</h1>
                        <div class="row mt">
                            <div class="col-lg-12">
                   ...
                   fiber_mini_store_history.transaction_id,fiber_mini_store_history.item_code,fiber_mini_store_history.requested_by,
                   fiber_mini_store_history.team1_accept,fiber_mini_store_history.team2_accept,fiber_mini_store_history.stock_in,
                   fiber_mini_store_history.stock_out,fiber_mini_store_history.balance,fiber_mini_store_history.saved_date,
                    inventory_items.item_description AS item_description, inventory_items.category AS category, 
                    inventory_items.uom AS uom
                    FROM fiber_mini_store_history  
                    INNER JOIN inventory_items ON fiber_mini_store_history.item_code = inventory_items.item_code";
                                    ...
                                    $request_query = "SELECT * FROM fiber_mini_store_request where status='active'";
                                    ...
                                    if ($role == "admin") {
                                        ...
                                        <button class="btn btn-success" style="float: left; margin-right: 10px; "
                                            data-toggle="modal" data-target="#saveReportModal" <?= $disabled ?>>Save</button>
                                        <?php
                                    }
                                    ?>
                                    ...
                                    <a href="#" class="btn btn-success text-white" id="historyExportBtn"
                                        style="float: right; margin-right: 10px;">
                                        <span>Export</span>
                                    </a>
                                    <a href="#" class="btn btn-info text-white" id="historyPrintBtn"
                                        style="float: right; margin-right: 10px;">
                                        <span>Print</span>
                                    </a>
                                    ...
                                    <section id="unseen">
                                        <table class="table table-bordered table-striped table-condensed"
                                            id="historyTable" style="table-layout: auto;">
                                            <thead>
                                                <tr>
                        ...
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" id="addModalLabel">Save Report</h5>
                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                        <span aria-hidden="true">&times;</span>
                                    </button>
                                </div>
                                <div class="modal-body">
                                    <form method="POST" action="../assets/php_query/fiber_mini_store_query/history_query.php">
                                        <div class="form-group">
                                            <label for="report_date">Select Date</label>
                                            <input type="date" name="report_date" id="report_date" class="form-control"
                                                required>
                                        </div>
                                        <button type="submit" class="btn btn-primary" name="save_report">Save</button>
                                    </form>
                                </div>
                            </div>
                        </div>
