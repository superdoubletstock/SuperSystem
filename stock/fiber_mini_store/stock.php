            ...
            <section class="wrapper">
                <div class="row">
                    <div class="col-lg-12 main-chart">
                        <h1>Fiber Mini Stock Balance</h1>
                        <div class="row mt">
                            <div class="col-lg-12">
                                <div class="content-panel">
                                    ...
                                    if ($role == "admin") {
                                        ...
                                        <button class="btn btn-success" style="float: left; margin-right: 10px;"
                                            data-toggle="modal" data-target="#StockINModal">REQUEST</button>

                                        <button class="btn btn-success" style="float: left; margin-right: 20px;"
                                            data-toggle="modal" data-target="#StockOUTModal">CONVERT TO KG</button>
                                    ...
                                    <?php
                                    include("connect.php");
                                    $dashboard_query = "SELECT fiber_mini_store_balance.balance,
                inventory_items.item_description AS item_description ,inventory_items.item_code AS item_code 
               , inventory_items.uom AS uom, inventory_items.conversion_rate AS conversion_rate 
                FROM fiber_mini_store_balance INNER JOIN inventory_items ON fiber_mini_store_balance.item_code = inventory_items.item_code WHERE status='active' ";
                                    $dashboard_run = mysqli_query($conn, $dashboard_query);
                                    $dashboard_data = mysqli_fetch_all($dashboard_run, MYSQLI_ASSOC);
                                    ?>
                                    <section id="unseen">
                                        <table class="table table-bordered table-striped table-condensed"
                                            id="StockTable" style="table-layout: auto;">
                                            <thead>
                                                <tr>
                                                    <th>Item Code</th>
                            ...
                            <div class="modal-dialog" role="document" style="width: 30%;">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <form id="addForm"
                                            action="../assets/php_query/fiber_mini_store_query/stock_query.php"
                                            method="POST" enctype="multipart/form-data">
                                            <div class="row">
                                                <?php
                                                include('connect.php');
                                                $inventory_sql = "SELECT item_code, item_description, uom FROM inventory_items where category='fiber'";
                                                ...
                                                <div class="col-md-6 form-group">
                                                    ...
                                                    <input type="text" class="form-control" id="Recived_by"
                                                        name="Recived_by" placeholder="Enter full name" required
                        ...
                        <div class="modal fade" id="StockOUTModal" tabindex="-1" role="dialog"
                            ...
                            <div class="modal-dialog" role="document" style="width: 30%;">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <form id="addForm" action="../assets\php_query\stock_query.php" method="POST"
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6 form-group">
                                                    ...
                                                    <input type="text" class="form-control" id="Received_by"
                                                        name="Received_by" placeholder="Enter Remark" required
                                                        value="<?php echo $fullname ?>" readonly>
                                                </div>
                                                ...
                                                <div class="col-md-12 form-group">
                                                    ...
                                                    <select class="form-control" id="department" name="department"
                                                        ...
                                                        <option value="fiber_mini_store">fiber MINI STORE</option>
                                                        <option value="fiber_mini_mini_store">FIBER MINI-MINI STORE
                                                        </option>
                                                        <option value="fiber_mini_mini_store">fiber MINI-MINI STORE
                                                        </option>
