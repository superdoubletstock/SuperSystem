     ...
     <?php
                    ...
                    <li class="sub-menu">
                     ...
                     <i class="fa fa-bell" style="position: relative; color: #fff;">
                      ...
                      <ul class="sub">
                          <li><a  href="request.php">Main Store</a></li>
                          <li><a  href="#">fiber Mini Mini Store</a></li>
            ...
            <section class="wrapper">
                <div class="row">
                    <div class="col-lg-12 main-chart">
                        ...
                        <h1>Fiber Mini Store request</h1>
                        <div class="row mt">
                            <div class="col-lg-12">
                                <div class="content-panel">
                                    <?php
                                    include("connect.php");
                                    $fiber="fiber_mini_store";
                                    $main_store_query = "SELECT 
                 main_store_request.In_Out,main_store_request.sender_team1_accept,main_store_request.sender_team2_accept,main_store_request.sender_team2_name,main_store_request.department,main_store_request.cancel,
                 main_store_request.sender_team1_name,main_store_request.qnty ,
                 main_store_request.transaction_id,main_store_request.requested_date,main_store_request.InFrom_OutTo,main_store_request.sender_name,
                inventory_items.item_description AS item_description ,inventory_items.item_code AS item_code , inventory_items.uom AS uom
                FROM main_store_request INNER JOIN inventory_items ON main_store_request.item_code = inventory_items.item_code where sender_status='inactive' and cancel='0' and department='$fiber'";
                                            ...
                                            <tbody>
                                                <?php foreach ($main_store_query_run_data as $request): ?>
                                                    <tr class="attendanceRow">
                                                        ...
                                                        if ($role == "admin") {
                                                            if ($request['sender_team1_accept'] == 1 && $request['sender_team2_accept'] == 1) {
                                                                ?>
                                                                <td>
                                                            ...
                                                            $team1 = $request['sender_team1_accept'];
                                                            $team2 = $request['sender_team2_accept'];
                                                            if ($team1 == 1 || $team1 == 2) {
                    ...
                    <div class="modal fade" id="deleteRequestmodal" tabindex="-1" role="dialog"
                        ...
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                <form id="deleteForm" action="../assets/php_query/fiber_mini_store_query/request_query.php" method="post">
                    ...
                    <div class="modal fade" id="AcceptRequestModal" tabindex="-1" role="dialog"
                        ...
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                <form id="acceptForm" action="../assets/php_query/fiber_mini_store_query/request_query.php" method="post">
                                    <div class="modal-header">
