    ...
    <div class="row mt">
        <div class="col-lg-12">
            <div class="content-panel">
                ...
                <?php
                include("connect.php");
               $fiber_mini_store = "SELECT 
    fiber_mini_store_report.item_code, 
    fiber_mini_store_report.stock_in, 
    fiber_mini_store_report.stock_out, 
    fiber_mini_store_report.balance, 
    fiber_mini_store_report.saved_by, 
    fiber_mini_store_report.saved_date,
    inventory_items.item_description AS item_description,
    inventory_items.category AS category, 
    inventory_items.uom AS uom
FROM fiber_mini_store_report
INNER JOIN inventory_items 
    ON fiber_mini_store_report.item_code = inventory_items.item_code";
                
                $fiber_mini_store_query_run = mysqli_query($conn, $fiber_mini_store);
                $fiber_mini_store_query_run_data = mysqli_fetch_all($fiber_mini_store_query_run, MYSQLI_ASSOC);
                ?>
                ...
                <section id="unseen">
                    <table class="table table-bordered table-striped table-condensed" id="reportTable" style="table-layout: auto;">
                        ...
                        <tbody>
                            <?php foreach ($fiber_mini_store_query_run_data as $request): ?>
                                <tr class="reportRow">
