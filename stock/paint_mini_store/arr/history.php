            ...
            <section class="wrapper">
                <div class="row">
                   ...
                   paint_mini_store_history.stock_out,paint_mini_store_history.balance,paint_mini_store_history.saved_date,
                    ...
                    INNER JOIN inventory_items ON paint_mini_store_history.item_code = inventory_items.item_code";
                        ...
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form method="POST" action="../assets/php_query/paint_mini_store_query/history_query.php">
