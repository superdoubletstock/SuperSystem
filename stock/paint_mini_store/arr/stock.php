            ...
            <section class="wrapper">
                <div class="row">
                    <div class="col-lg-12 main-chart">
                        <h1>Paint Mini Stock Balance</h1>
                        <div class="row mt">
                            <div class="col-lg-12">
                                <div class="content-panel">
                                    ...
                                    <?php
                                    include("connect.php");
                                    $dashboard_query = "SELECT paint_mini_store_balance.balance,
                            ...
                            <div class="modal-dialog" role="document" style="width: 30%;">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <form id="addForm"
                                            action="../assets/php_query/paint_mini_store_query/stock_query.php"
                                            method="POST" enctype="multipart/form-data">
                                            <div class="row">
                                                <?php
                                                include('connect.php');
                                                $inventory_sql = "SELECT item_code, item_description, uom FROM inventory_items where category='paint'";
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-12 form-group">
                                                    ...
                                                    <select class="form-control" id="department" name="department"
                                                        ...
                                                        <option value="paint_mini_mini_store">PAINT MINI-MINI STORE
                                                        </option>
