                    ...
                    <li class="sub-menu">
                     ...
                     <i class="fa fa-bell" style="position: relative; color: #fff;">
                      ...
                      <ul class="sub">
                          ...
                          <li><a  href="#">Paint Mini Mini Store</a></li>
            ...
            <section class="wrapper">
                <div class="row">
                    <div class="col-lg-12 main-chart">
                        ...
                        <h1>Paint Mini Store request</h1>
                        <div class="row mt">
                            <div class="col-lg-12">
                                <div class="content-panel">
                                    <?php
                                    include("connect.php");
                                    $paint="paint_mini_store";
                ...
                FROM main_store_request INNER JOIN inventory_items ON main_store_request.item_code = inventory_items.item_code where sender_status='inactive' and cancel='0' and department='$paint'";
                    ...
                    <div class="modal fade" id="deleteRequestmodal" tabindex="-1" role="dialog"
                        ...
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                <form id="deleteForm" action="../assets/php_query/paint_mini_store_query/request_query.php" method="post">
