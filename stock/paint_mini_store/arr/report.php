...
INNER JOIN inventory_items 
    ON paint_mini_store_report.item_code = inventory_items.item_code";
                
                $paint_mini_store_query_run = mysqli_query($conn, $paint_mini_store);
                $paint_mini_store_query_run_data = mysqli_fetch_all($paint_mini_store_query_run, MYSQLI_ASSOC);
                ?>
                ...
                <section id="unseen">
                    <table class="table table-bordered table-striped table-condensed" id="reportTable" style="table-layout: auto;">
                        ...
                        <tbody>
                            <?php foreach ($paint_mini_store_query_run_data as $request): ?>
                                <tr class="reportRow">
